    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="mainPageIndex"><h1><img src="assets/images/logo.png" alt="" /></h1></a>
        </div>
			...
			<div class="header-top-right">
				...
				<div class="signin">
					...
					<!-- pop-up-box -->
									...
									<div id="small-dialog2" class="mfp-hide">
										...
										<div class="signup">
											<form>
												<input type="text" class="email" placeholder="Mobile Number" name="mobNo" />
											</form>
									...
									<div id="small-dialog3" class="mfp-hide">
										...
										<div class="signup">
											<form action="loginofUser">
												<input type="text" class="email" placeholder="Name" required="required"  name="name" autocomplete="off" />
												<input type="text" name="email" class="email" placeholder="Email" required="required" />
												<input type="text" name="mobNo" class="email" placeholder="Mobile No" required="required" />
				...
				<div class="signin">
					...
					<div id="small-dialog" class="mfp-hide">
						...
						<div class="signup">
							<form action="userLoginCredintails" method="post">
								<input type="text" class="email" name="email" placeholder="Enter email / mobile" />
