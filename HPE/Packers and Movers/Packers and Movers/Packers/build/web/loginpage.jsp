...
<![endif]-->
  ...
  <div id="in" class="home">
    ...
    <div id="body">
      <div id="banner" class="cbox">
        ...
        <div id="b_lft"> <img src="images/packers-movers-miyapur.jpg" alt="" /><br />
      ...
      <div class="marginBottom30">
                    ...
                    <div class="col1-2">
                         <a class="photo" href="./"><img src="images/login.png" alt="empty" /></a>
                     
                       </div>
          <div class="col1-2">
              <h2>Login</h2>
              <li><a href="logadmin.jsp" class="bbut">Administration</a></li><br> <br>
                      <li><a href="logagents.jsp" class="bbut">Agents</a></li></br></br>
      ...
      <div class="row">
        <div class="col">
          ...
          <p>This is a leading "Packers and Movers" organization that offers transportation and relocation solutions. We are the most reliable company for cargo and logistics. We provide safe and reliable solutions for consumers</p>
  ...
  <p>Packers and Movers,Dange chowk,thegaon pune,411042.</p>
          <p>Phone no-9874563210</p>
