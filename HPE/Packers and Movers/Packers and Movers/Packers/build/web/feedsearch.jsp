...
<div id="main">
  <div id="in" class="home">
    ...
    <a href="index.html"><img src="images/logo.png" alt="site name" /></a>
      <div id="navigation" class="cbox">
        ...
        <ul>
          ...
          <li><a href="feedbackdata.jsp">Back</a></li>
    ...
    <div id="body">
                  ...
                  <center><h1 style="background-color: #d5d5d5">Feedback Reports</h1></center>
           </div>
           <!--banner-->
           ...
           <%
            try
                                 ...
                                 String str = "select * from feedback where company = '"+company+"'";
