...
<![endif]-->
  ...
  <div id="in" class="home">
    ...
    <div id="body">
      <div class="col1-2">
                  <center><h1 style="background-color: #d5d5d5">Feedback Details</h1></center>
      </div>
                     <form method="post" action="feedsearch.jsp">
      
                         <div class="col1-2">
              
              <input type="text" placeholder="Company" name="search" value="<%= company %>"/>
            ...
            try
                                  {
                                   ...
                                   out.println("<th>Feedback_ID</th><th>Name</th><th>Company</th><th>Address</th><th>City</th><th>Pincode</th><th>Email</th><th>Phone</th><th>Experience</th><th>Comments</th><th>Delete</th></tr>");
                                  ...
                                  out.println("<td><a href= 'feedbackdel.jsp?"+id+"'>Delete</a></td></tr>");
