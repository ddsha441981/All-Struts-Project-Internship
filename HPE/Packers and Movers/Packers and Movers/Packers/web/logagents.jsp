...
<script>
        ...
        {   
            var user=document.agntlogin.user.value;
            var pass=document.agntlogin.pass.value;
  ...
  <div id="in" class="home">
    ...
    <div id="body">
      ...
      <div class="marginBottom30">
          ...
          <div class="col1-2">
                           <h2>Agents Login</h2>                                      
                           <form name="agntlogin" method="post" action="AgentLogin" onsubmit=" return validationform()">
                            UserName:- <input type="text" name="user"/><br> <br>
                            Password:- <input type="password" name="pass"/></br></br>
                               <input type="submit" value="Sigin"/>
                                
                               <div class="col1-2">
                               <center><a class="photo" href="Agntpage.jsp"><img src="images/Register1.jpg" alt="empty"/></a></br><br></br></center>
                               </div>
                               <div class="col1-2">
                               <center><a class="photo" href="agentChangePassword.jsp"><img src="images/changes.jpg" alt="empty"/></a></br><br></br></center>
                               </div>
