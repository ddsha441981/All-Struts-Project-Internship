...
<div class="container">
  ...
  <hidden name="id" value="%{phone.id}"></hidden>
 
    <div class="form-group">
      <label class="control-label col-sm-2" for="Name">Name:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="Name" placeholder="Enter Name" required="" value="{phone.Name}">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="Mobile" placeholder="Enter Mobile" required="" value="{phone.Mobile}">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="Email" placeholder="Enter Email"  required="" value="{phone.Email}">
      </div>
    </div>
