    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span>Add Nominee Health</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
      <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/healthNomineesave" method="post">
		 ...
		 <div class="form-group">
				Select Policy <select id="first-disabled" class="selectpicker"
					...
					<optgroup label="Select  Option">
						...
						<s:forEach items="${list}" var="viewsoflists">
						<option value="${viewsoflists.policyId}">${viewsoflists.policyName}</option>
