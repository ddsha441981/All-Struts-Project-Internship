...
<div class="container">
  ...
  <button type="button" class="btn btn-default btn-lg" id="myagent">Agent Login</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span> Agent Login</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" action="agentlogin" method="post">
            <div class="form-group">
              <label for="username"><span class="glyphicon glyphicon-user"></span> Username</label>
              <input type="text" class="form-control" id="username" placeholder="Enter Username" name="agentName">
            </div>
            <div class="form-group">
              <label for="password"><span class="glyphicon glyphicon-eye-open"></span> Password</label>
              <input type="password" class="form-control" id="password" placeholder="Enter password" name="agentpassword">
            </div>
            <div class="checkbox">
        ...
        <div class="modal-footer">
          ...
          <p>Forgot <a  id="myagentforgot">Password?</a></p>
        </div>
      </div>
