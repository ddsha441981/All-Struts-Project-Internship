...
public class TestEmp {
	...
	public static void main(String[] args) {
		...
		a1.add(new Employee(11, "Deendayal", skill3));
		a1.add(new Employee(11, "Deendayal", skill4));
		...
		System.out.println("All Data Print Before Data Sort\n"+a1);//All Data Print(Before Data Sort)
		Collections.sort(a1);//After Sort Data only id
		System.out.println("After Sort My data\n"+a1);//All Data Print(After Data Sort)
