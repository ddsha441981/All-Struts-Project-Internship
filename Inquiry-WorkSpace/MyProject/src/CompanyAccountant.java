 class CompanyAccountant extends CompanyEmployee implements Company, Sologn,Massage {
	

	 CompanyAccountant(String eId, String eN, double sal, String tech) {
	...
	return "CompanyAccountant Id" + empId + "CompanyAccountant Name " + empN + "Salary"
	+ salary;
}
	public void thank() {
