            ...
            try
                                  {
                                   ...
                                   out.println("<form method= 'post' action='DriverInsert'>");
                                   out.println("<tr><td><input type='text' name='driverid'/></td>");
                                   ...
                                   out.println("<td><input type='text' name='Idproof'/></td>");
                                   out.println("<td><input type='text' name='salary'/></td>");
