...
<![endif]-->
  ...
  <div id="in" class="home">
    ...
    <div id="body">
      <div class="col1-2">
                  <center><h1 style="background-color: #d5d5d5">Agent Profile Update</h1></center>
      </div>
                             <form method="post" action="agntprosearch.jsp">
            ...
            try
                                  {
                                   ...
                                   out.println("<td><a href= 'profileedit.jsp?"+id+"'>Edit</a></td>");
