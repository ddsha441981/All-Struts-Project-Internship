    ...
    <a href="index.html"><img src="images/logo.png" alt="site name" /></a>
      <div id="navigation" class="cbox">
        ...
        <ul>
          ...
          <li><a href="agentprofile.jsp">Back</a></li>
    ...
    <div id="body">
        <div class="row"> 
         ...
         %>
                  ...
                  <center><h1 style="background-color: #d5d5d5">Agent Reports</h1></center>
           </div>
           <!--banner-->
            ...
            try
                                  {
                                   Connection con=DbConnection.dataConnection();
                                       ...
                                       Statement stmt=con.createStatement();
                                 String str = "select agnt_id,name_org,address,city,state,pincode,name,phone,email,mobile,service_id from agents where name = '"+name+"'";
                                   ResultSet rs=stmt.executeQuery(str);
                                   out.println("<table border= '1' align='center' width='40%'>");
                                   out.println("<th>Agent_Id</th><th>Org_Name</th><th>Address</th><th>City</th><th>State</th><th>Pincode</th><th>Name</th><th>Phone</th><th>Email</th><th>Mobile</th><th>Service_type</th><th>Edit</th></tr>");
                             ...
                             out.println("<td><a href= 'agntproedit.jsp?"+id+"'>Edit</a></td>");
