       ...
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                    ...
                    <ul class="collapse" id="DDL-nav">
                        <li>
                            <a href="#" data-parent="#DDL-nav" data-toggle="collapse" class="accordion-toggle" data-target="#DDL1-nav">
                                <i class="icon-sitemap"></i>&nbsp; My Page
                        ...
                        <span class="pull-right" style="margin-right: 20px;">
                            ...
                            <ul class="collapse" id="DDL1-nav">
                                <li>
                                    <a href="register.jsp"><i class="icon-angle-right"></i> Register </a>

                                </li>
                                <li>
                                    <a href="redirectMainPage"><i class="icon-angle-right"></i> ViewPart </a></li>
                                <li>
                ...
                <li><a href="gallary.jsp"><i class="icon-film"></i> Image Gallery </a></li>
