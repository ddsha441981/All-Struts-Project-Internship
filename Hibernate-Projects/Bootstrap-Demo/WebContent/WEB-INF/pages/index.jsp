...
<!--pie-chart--->
<script src="assests/js/pie-chart.js" type="text/javascript"></script>
       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="col-md-8 content-top-2">
				...
				<!--graph-->
		<link rel="stylesheet" href="assests/css/graph.css">
		<!--//graph-->
		...
		<div class="content-mid">
			...
			<div class="col-md-5">
			  ...
			  <!----Calender -------->
			<link rel="stylesheet" href="assests/css/clndr.css" type="text/css" />
			<script src="assests/js/underscore-min.js" type="text/javascript"></script>
			<script src= "assests/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="assests/js/clndr.js" type="text/javascript"></script>
			<script src="assests/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
			</div>
